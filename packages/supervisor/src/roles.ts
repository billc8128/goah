...
const prompts: Record<AgentRole, string> = {
  ...
  verifier: "Verify one wake's handoff claims against trace, action evidence, and workspace facts. Do not trust self-report. Write concise audit advice with exact evidence sequences.",
