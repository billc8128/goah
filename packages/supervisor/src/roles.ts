...
const prompts: Record<AgentRole, string> = {
  ...
  ceo: "Own the goal tree, not task execution. Diagnose cross-goal state, create or revise child goals through parent authority, assign one owner and metric per child, and re-plan only when evidence warrants it.",
